...
puts "What are the odds of Side 1 win outcome (decimal): "
odds_side1_win = gets.chomp.to_f
puts "Implied: #{(1/odds_side1_win).round(2)}"
puts "What are the odds of Side 2 win outcome (decimal): "
odds_side2_win = gets.chomp.to_f
puts "Implied: #{(1/odds_side2_win).round(2)}"
puts "\n \n"
...
full_one = ((((odds_side1_win * prob_side1_win)-1))/(odds_side1_win-1)) * (bankroll)
full_two = ((((odds_side2_win * prob_side2_win)-1))/(odds_side2_win-1)) * (bankroll)
...
puts "********************Kelly Table*******************"
puts "*                                                *"
puts "*     At:    15%    25%    50%    75%    Full    *"
puts "*                                                *"
puts "* Side 1:    #{full_one.round(2) * 0.15}    #{full_one.round(2) * 0.25}    #{full_one.round(2) * 0.50}    #{full_one.round(2) * 0.75}    #{full_one.round(2)} *"
puts "*                                                *"
puts "* Side 2:    #{full_two.round(2) * 0.15}    #{full_two.round(2) * 0.25}    #{full_two.round(2) * 0.50}    #{full_two.round(2) * 0.75}    #{full_two.round(2)} *"
puts "*                                                *"
puts "*                                                *"
puts "**************************************************"
